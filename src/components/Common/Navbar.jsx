...
function Navbar() {
  ...
  //   }
  //   catch (err) {
  //     console.log("There is some  error to fetch all categories ", err)
  //   }
  // }
                ...
                {link.title === "Catalog" ? (
                  <>
                    ...
                    <div className=" relative flex items-center gap-2 group">
                      ...
                      {/* for drop down square */}
                      <div className=" invisible absolute left-[50%] top-[50%] z-10 translate-x-[-50%] translate-y-[20%] flex flex-col rounded-md bg-richblack-5 p-4 text-richblack-900 
                      opacity-0 transition-all duration-200 group-hover:visible group-hover:opacity-100 lg:w-[200px]">
